...
Run `task validate` before handing off llm-gateway changes. Also run targeted
unit, integration, contract, or platform checks when the change touches behavior
