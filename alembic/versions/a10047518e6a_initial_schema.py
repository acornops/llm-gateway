...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("oauth_issuer", sa.String(), nullable=True),
        sa.Column("oauth_registration_method", sa.String(), nullable=True),
        sa.Column("oauth_resource", sa.String(), nullable=True),
        ...
        sa.Column("oauth_refresh_capable", sa.Boolean(), nullable=False),
        sa.Column(
            "created_at", sa.DateTime(timezone=True), server_default=sa.text("now()"), nullable=True
        ),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_table(
        "gateway_mcp_oauth_registrations",
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("workspace_id", sa.String(), nullable=False),
        sa.Column("server_id", sa.UUID(), nullable=False),
        sa.Column("resource", sa.String(), nullable=False),
        sa.Column("issuer", sa.String(), nullable=False),
        sa.Column("registration_method", sa.String(), nullable=False),
        ...
        sa.Column("client_metadata_fingerprint", sa.String(length=64), nullable=False),
        sa.Column(
            "scopes",
            sa.JSON().with_variant(postgresql.JSONB(astext_type=sa.Text()), "postgresql"),
            nullable=False,
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_gateway_mcp_oauth_registrations_workspace_server",
        table_name="gateway_mcp_oauth_registrations",
    )
    op.drop_table("gateway_mcp_oauth_registrations")
    op.drop_index(
